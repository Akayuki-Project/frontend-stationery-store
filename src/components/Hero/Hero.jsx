...
const Hero = () => {
  return (
    <section
      id="home"
      className="bg-secondary text-white min-h-screen flex flex-col-reverse md:flex-row items-center justify-center px-6 md:px-20 py-20 md:py-32 lg:py-40"
    >
      <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[450px] relative">
        ...
        <div className="flex flex-col justify-center py-14 md:py-0 relative z-10">
          <div className="text-center md:text-left space-y-6 lg:max-w-[450px]">
            ...
            >
              Belajar, bekerja, atau berkarya—semua lebih seru dengan
